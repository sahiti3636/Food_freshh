...
YOLO_MODEL_URL = "https://drive.google.com/uc?export=download&id=1KLwWZuX8kImhOfdUC3MlMZqGyMQUtv4Y"
FRESHNESS_MODEL_URL = "https://drive.google.com/uc?export=download&id=1zO0Kv5QepXNfxF033kBfJYmkyGK0zz3e"
...
def download_model_if_missing(path, url):
    if not os.path.exists(path) or os.path.getsize(path) < 1024:
        print(f"Model {path} not found or corrupted. Downloading...")
